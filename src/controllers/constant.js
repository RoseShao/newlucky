                    ...
                    <div class="luckysheet-work-area luckysheet-noselected-text"> 
                        ...
                        <div id="luckysheet-wa-calculate" class="luckysheet-wa-calculate"> 
                            ...
                            <div id="luckysheet-wa-functionbox-cancel" class="luckysheet-wa-functionbox">
                                <span><i class="luckyIconfont luckysheet-iconfont-qingchu" aria-hidden="true"></i></span>
                            </div> 
                            <div id="luckysheet-wa-functionbox-confirm" class="luckysheet-wa-functionbox">
                                <span><i class="luckyIconfont luckysheet-iconfont-yunhang" aria-hidden="true"></i></span>
                            </div> 
                            <div id="luckysheet-wa-functionbox-fx" class="luckysheet-wa-functionbox">
                                <span><i class="luckyIconfont luckysheet-iconfont-hanshu" aria-hidden="true" style="color:#333"></i></span> 
                            </div> 
                        ...
                        <div class="luckysheet-grid-window"> 
                            ...
                            <div class="luckysheet-sheet-area luckysheet-noselected-text" id="luckysheet-sheet-area">
                                <div id="luckysheet-sheet-content">
                                    <div id="luckysheet-sheets-add" class="luckysheet-sheets-add lucky-button-custom"><i class="luckyIconfont luckysheet-iconfont-jia1"></i></div>
                                    <div id="luckysheet-sheets-m" class="luckysheet-sheets-m lucky-button-custom"><i class="luckyIconfont luckysheet-iconfont-caidan2"></i></div>
                        ...
                        <div class="luckysheet-stat-area"> 
                            <div class="luckysheet-sta-c">
                                ...
                                <div class="luckysheet-print-viewList">
                                    <div type="viewNormal" class="luckysheet-print-viewBtn luckysheet-print-viewNormal luckysheet-print-viewBtn-active" title="${locale_print.normalBtn}"><i class="icon luckyIconfont luckysheet-iconfont-putong"></i></div>
                                    <div type="viewLayout" class="luckysheet-print-viewBtn luckysheet-print-viewLayout" title="${locale_print.layoutBtn}"><i class="icon luckyIconfont luckysheet-iconfont-yemianbuju"></i></div>
                                    <div type="viewPage" class="luckysheet-print-viewBtn luckysheet-print-viewPage" title="${locale_print.pageBtn}"><i class="icon luckyIconfont luckysheet-iconfont-fenyeyulan"></i></div>
                                </div>
...
function rightclickHTML(){
    ...
    const rightclickContainer =  `<div id="luckysheet-rightclick-menu" class="luckysheet-cols-menu luckysheet-rightgclick-menu luckysheet-mousedown-cancel">
                ...
                <div id="luckysheetcopyfor" class="luckysheet-cols-menuitem luckysheet-cols-submenu luckysheet-mousedown-cancel"  style="display:${config.copyAs ? 'block' : 'none'};">
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                        ${rightclick.copyAs}<span class="luckysheet-submenu-arrow luckyIconfont luckysheet-iconfont-youjiantou" style="user-select: none;"></span>
                    </div>
                </div>
                ...
                <div id="luckysheet-cols-rows-handleincell">
                    ...
                    <div id="luckysheetColsRowsHandleHid" class="luckysheet-cols-menuitem luckysheet-cols-submenu luckysheet-mousedown-cancel">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                            ${rightclick.hide}<span class="luckysheet-submenu-arrow luckyIconfont luckysheet-iconfont-youjiantou" style="user-select: none;"></span>
                        </div>
                    </div>
                    -->
                    <div id="luckysheetCellsHandleDel" class="luckysheet-cols-menuitem luckysheet-cols-submenu luckysheet-mousedown-cancel" style="display:${config.deleteCell ? 'block' : 'none'};">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                            ${rightclick.deleteCell}<span class="luckysheet-submenu-arrow luckyIconfont luckysheet-iconfont-youjiantou" style="user-select: none;"></span>
                        </div>
                    </div>
                </div>
                ...
                <div id="luckysheet-cols-rows-data">
                    ...
                    <div id="luckysheetmatrix" class="luckysheet-cols-menuitem luckysheet-cols-submenu luckysheet-mousedown-cancel" style="display:${config.matrix ? 'block' : 'none'};">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                            ${rightclick.matrix}<span class="luckysheet-submenu-arrow luckyIconfont luckysheet-iconfont-youjiantou" style="user-select: none;"></span>
                        </div>
                    </div>
...
function sheetconfigHTML(){
    ...
    const sheetconfigModel = `<div id="luckysheet-rightclick-sheet-menu" class="luckysheet-cols-menu luckysheet-rightgclick-menu luckysheet-mousedown-cancel"> 
                ...
                <div id="luckysheetsheetconfigcolor" class="luckysheet-cols-menuitem luckysheet-cols-submenu luckysheet-mousedown-cancel" style="display:${config.color ? 'block' : 'none'};"> 
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel"> 
                        ${sheetconfig.changeColor} <span class="luckysheet-submenu-arrow luckyIconfont luckysheet-iconfont-youjiantou" style="user-select: none;"></span> 
                    </div> 
                </div> 
...
const iconfontObjects = {
    border:{
        'border-top': ' luckyIconfont luckysheet-iconfont-shangbiankuang',
        'border-bottom': ' luckyIconfont luckysheet-iconfont-xiabiankuang',
        'border-left': ' luckyIconfont luckysheet-iconfont-zuobiankuang',
        'border-right': ' luckyIconfont luckysheet-iconfont-youbiankuang',
        'border-none': ' luckyIconfont luckysheet-iconfont-wubiankuang',
        'border-all': ' luckyIconfont luckysheet-iconfont-quanjiabiankuang',
        'border-outside': ' luckyIconfont luckysheet-iconfont-sizhoujiabiankuang',
        'border-inside': ' luckyIconfont luckysheet-iconfont-neikuangxian',
        'border-horizontal': ' luckyIconfont luckysheet-iconfont-neikuanghengxian',
        'border-vertical': ' luckyIconfont luckysheet-iconfont-neikuangshuxian',
    },
    align:{
        'left': ' luckyIconfont luckysheet-iconfont-wenbenzuoduiqi',
        'center': ' luckyIconfont luckysheet-iconfont-wenbenjuzhongduiqi',
        'right': ' luckyIconfont luckysheet-iconfont-wenbenyouduiqi',
        'top': ' luckyIconfont luckysheet-iconfont-dingbuduiqi',
        'middle': ' luckyIconfont luckysheet-iconfont-shuipingduiqi',
        'bottom': ' luckyIconfont luckysheet-iconfont-dibuduiqi',
    },
    textWrap:{
        'overflow': ' luckyIconfont luckysheet-iconfont-yichu1',
        'wrap': ' luckyIconfont luckysheet-iconfont-zidonghuanhang',
        'clip': ' luckyIconfont luckysheet-iconfont-jieduan',
    },
    rotation:{
        'none': ' luckyIconfont luckysheet-iconfont-wuxuanzhuang',
        'angleup': ' luckyIconfont luckysheet-iconfont-xiangshangqingxie',
        'angledown': ' luckyIconfont luckysheet-iconfont-xiangxiaqingxie',
        'vertical': ' luckyIconfont luckysheet-iconfont-shupaiwenzi',
        'rotation-up': ' luckyIconfont luckysheet-iconfont-wenbenxiangshang',
        'rotation-down': ' luckyIconfont luckysheet-iconfont-xiangxia90',
    }
}
