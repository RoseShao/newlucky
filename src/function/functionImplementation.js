...
const functionImplementation = {
    ...
    "SECOND": function() {
        ...
        try {
            ...
            var result = dayjs(time_text).second();
    ...
    "MINUTE": function() {
        ...
        try {
            ...
            var result = dayjs(time_text).minute();
    ...
    "HOUR": function() {
        ...
        try {
            ...
            var result = dayjs(time_text).hour();
    ...
    "WEEKNUM": function() {
        ...
        try {
            ...
            var result = dayjs(serial_number).isoWeek() + inc;
